...
class FileMatcherTest(unittest.TestCase):
    ...
    TEST_SEARCH_IN_DIRECTORY_RELATIVE_PATH = 'testfolder'
    ...
    def setUp(self):
        ...
        self.__file_handler.create_dir(self.TEST_SEARCH_IN_DIRECTORY_RELATIVE_PATH)

    def tearDown(self):
        self.__file_handler.delete_directory(self.TEST_SEARCH_IN_DIRECTORY_RELATIVE_PATH)

    def runTest(self):
        self.__file_handler.create_file(self.TEST_FILE_RELATIVE_PATH)
        search_for = 'The Big Bang Theory'
        file_paths = self.__file_mather.search_files(search_for, self.TEST_SEARCH_IN_DIRECTORY_RELATIVE_PATH)
