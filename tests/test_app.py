...
class AppTest(unittest.TestCase, file_mover_tester.FileMoverTester):
    ...
    def test_moving_show_by_episode(self):
        ...
        self.assertFileMoved(self._SOURCE_DIRECTORY + '/' + self.__TV_SHOW_FILE_NAME_3, destination_path)
    ...
    def test_moving_show_by_name(self):
        ...
        self.assertFileMoved(self._SOURCE_DIRECTORY + '/' + self.__TV_SHOW_FILE_NAME_1, destination_path)
    ...
    def test_moving_movie_by_name(self):
        ...
        self.assertFileMoved(self._SOURCE_DIRECTORY + self.__MOVIE_FILE_NAME_2, destination_path)
    ...
    def test_moving_movie_by_file(self):
        ...
        self.assertFileMoved(self._SOURCE_DIRECTORY + '/' + self.__MOVIE_FILE_NAME_1, destination_path)
    ...
    def test_moving_show_by_file(self):
        ...
        self.assertFileMoved(self._SOURCE_DIRECTORY + '/' + self.__TV_SHOW_FILE_NAME_2, destination_path)
