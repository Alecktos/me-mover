...
class MediaFileExtractorTest(unittest.TestCase):
    ...
    __SOURCE_FILES = [
        ...
        'testing/intetest/Other.Other.Other.Other.S09E01.something.something-something[something].srt',
    ...
    __SUBTITLES_FILES = [
        'testing/test/Another.Another.S02E03.bigfile.srt',
        'testing/test/Another.Another.S02E03.bigfile.smi',
        'testing/test/Another.Another.S02E03.bigfile.ssa',
        'testing/test/Another.Another.S02E03.bigfile.ass',
        'testing/test/Another.Another.S02E03.bigfile.vtt'
    ]
    ...
    def test_renaming_subs(self):
        ...
        subtitles_renamer.rename('testing')
