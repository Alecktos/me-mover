...
class MoverTest(unittest.TestCase, file_moved_assertion.FileMovedAssertion):
    ...
    def test_move_show_by_name(self):
        ...
        destination_path = self.__SHOW_DESTINATION_DIRECTORY + '/All the Things Fire/Season 2/' + tv_show_file_name
    ...
    def test_move_show_by_file_path(self):
        ...
        destination_path = self.__SHOW_DESTINATION_DIRECTORY + '/Man In The on Folder/Season 2/' + tv_show_file_name
    ...
    def test_move_shows_into_existing_season_directory(self):
        ...
        file_handler.create_dir(self.__SHOW_DESTINATION_DIRECTORY + '/Kontroll/Season 7/')
        ...
        file_destination_path = self.__SHOW_DESTINATION_DIRECTORY + '/Kontroll/Season 7/' + tv_show_file_name
        ...
        file_handler.create_dir(self.__SHOW_DESTINATION_DIRECTORY + '/Cool And Welcome To Earth/Season 2/')
        ...
        file_destination_path = self.__SHOW_DESTINATION_DIRECTORY + '/Cool And Welcome To Earth/Season 2/' + tv_show_file_name
        self.assertFileMoved(file_source_path, file_destination_path)
    ...
    def test_moving_episodes_by_name_in_directory(self):
        folder_path = self.__SOURCE_DIRECTORY + '/Cool.And.Welcome.To.Earth.S01.Season.1.720p.5.1Ch.Web-DL.ReEnc-DeeJayAhmed'
        file_handler.create_dir(folder_path)
        ...
        self.assertFileMoved(file_path_1, self.__SHOW_DESTINATION_DIRECTORY + '/Cool And Welcome To Earth/Season 1/Cool.And.Welcome.To.Earth.S01E13.720p.5.1Ch.Web-DL.ReEnc-DeeJayAhmed.mkv')
    ...
    def test_moving_movies_by_name(self):
        ...
        file_2_path = self.__SOURCE_DIRECTORY + '/201 Coolings 200.DADRAP.NVesub.mp4'
    ...
    def test_moving_wrong_formatted_episode_inside_right_formated_directory(self):
        folder_path = self.__SOURCE_DIRECTORY + '/My.Stuff.Us.On.S10E09.HDTV.CCCC-ARD[axel]'
        file_handler.create_dir(folder_path)
        file_path = folder_path + '/my.stuff.us.on.1009.fktv-uuu[axel].mkv'
        file_handler.create_file(file_path)

        mover.move_media_by_path(file_path, self.__SHOW_DESTINATION_DIRECTORY, self.__MOVIE_DESTINATION_DIRECTORY)
        self.assertFileMoved(folder_path, self.__SHOW_DESTINATION_DIRECTORY + '/My Stuff Us On/Season 10/my.stuff.us.on.1009.fktv-uuu[axel].mkv')