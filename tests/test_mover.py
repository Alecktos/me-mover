...
class MoverTest(unittest.TestCase, file_mover_tester.FileMoverTester):
    ...
    def test_moving_episodes_by_name_in_directory(self):
        ...
        self.assertFileMoved(file_path_1, self._SHOW_DESTINATION_DIRECTORY + '/Cool And Welcome To Earth/Season 1/Cool.And.Welcome.To.Earth.S01E13.720p.5.1Ch.Web-DL.ReEnc-DeeJayAhmed.mkv')
    ...
    def test_moving_wrong_formatted_episode_inside_right_formated_directory(self):
        ...
        mover.move_media_by_path(file_path, self._SHOW_DESTINATION_DIRECTORY, self._MOVIE_DESTINATION_DIRECTORY)
        self.assertFileMoved(folder_path, self._SHOW_DESTINATION_DIRECTORY + '/My Stuff Us On/Season 10/my.stuff.us.on.1009.fktv-uuu[axel].mkv')